...
<body>
  ...
  <div class="container-fluid text-light" style="height: 100vh;">
    <div class="nav row justify-content-evenly text-center align-items-center">
      <div class="col-sm-6">
        <div class="card text-bg-secondary mb-3">
          <div class="card-body">
            <h3 class="card-title fw-bold">LABORATORY GOODS AVAILABILITY INFORMATION</h3>
    ...
    <!--Data END-->
    <!--Card Item Start-->
    <div class="row justify-content-evenly text-center align-items-center mt-lg-4 text-dark">
      <div class="col-sm-6">
