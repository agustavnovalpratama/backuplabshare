...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fw-bolder">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="assets/logosmk.png" style="height: 70px;" alt=""></a>
    ...
    <div class="nav row justify-content-evenly text-center align-items-center mt-4">
      <div class="col-sm-12">
        <div class="card text-bg-secondary mb-3">
          <div class="card-body">
            <h3 class="card-title fw-bold">WELCOME TO THE LABORATORY SMKN 11 MALANG</h3>
            <p class="card-text">This website provides a system for borrowing goods at the SMKN 11 MALANG Laboratory Online <i class="fa-solid fa-clock"></i></p>
