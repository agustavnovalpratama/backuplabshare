        ...
        <table class="table table-striped table-bordered">
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="#" data-toggle="modal" data-target="#editmhs<?php echo $data['nim']; ?>"><i class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="update_peminjaman.php" method="post" role="form">
                        <?php
                        $nim = $data['nim'];
                        $query1 = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE nim='$nim'");
                        ...
                        ?>
                          ...
                          <div class="form-group mt-2">
                            <div class="row">
                              ...
                              <div class="col-sm-8"><input type="text" class="form-control" name="no_hp" value="<?php echo $data1['no_hp']; ?>"></div>
                            </div>
                          </div>
                          <div class="form-group mt-2">
                            <div class="row">
                          ...
                          <div class="form-group mt-2">
                            <div class="row">
                              <label class="col-sm-3 control-label text-right">Tgl PINJAM </label>
                              <div class="col-sm-8"><input type="text" class="form-control" name="tgl_pinjam" value="<?php echo $data1['tgl_pinjam']; ?>"></div>
                            </div>
                          </div>
                          <div class="form-group mt-2">
                            <div class="row">
                              <label class="col-sm-3 control-label text-right">Tgl KEMBALI </label>
                              <div class="col-sm-8"><input type="text" class="form-control" name="tgl_kembali" value="<?php echo $data1['tgl_kembali']; ?>"></div>
                            </div>
                          </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="hapus_peminjaman.php?nim=<?php echo $data['nim']; ?>" class="btn btn-primary">Delete</a>
                    </div>
                  </div>
                </div>
              </div>
