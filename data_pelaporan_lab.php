    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="home_lab.php">Home</a>
          </li>
    ...
    <div class="nav row justify-content-evenly text-center align-items-center">
      <div class="col-sm-10">
        <div class="card text-bg-warning mb-3">
          <div class="card-body">
            <h3 class="card-title fw-bold">DATA PELAPORAN ALAT LABORATORIUM</h3>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <h5>Apakah anda yakin ingin menghapus Id Alat ini <?php echo $data['idalat']; ?><strong><span class="grt"></span></strong> ?</h5>
                    </div>
                    <div class="modal-footer">
                      <button id="nodelete" type="button" class="btn btn-danger pull-left" datadismiss="modal">Cancel</button>
                      <a href="hapus_pelaporan.php?idalat=<?php echo $data['idalat']; ?>" class="btn btn-primary">Delete</a>
                    </div>
                  </div>
                </div>
              </div>
