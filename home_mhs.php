    ...
    <div class="row justify-content-evenly text-center align-items-center text-body">
      <div class="nav row justify-content-evenly text-center align-items-center">
        <div class="col-sm-6">
          <div class="card text-bg-secondary mb-3">
            <div class="card-body">
              <h3 class="card-title fw-bold">Halo, <?= $_SESSION['nama'] ?></h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-12 g-3 mt-4">
          <div class="card">
            <div class="card-body text-body">
              <h5 class="card-title text-center">Borrowing Data</h5>
              <a href="data_peminjaman_mhs.php" class="btn btn-dark d-block">Pergi</a>
        ...
        <div class="col-sm-12 g-3 mt-4">
          <div class="card">
            <div class="card-body text-body">
              ...
              <a href="data_pengembalian_mhs.php" class="btn btn-dark d-block">Pergi</a>
