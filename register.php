    ...
    <div class="container p-5">
      <form method="POST" action="new_user.php">
        ...
        <table class="form-table">
          ...
          <tr>
            <td>
              <input type="text" name="nama" id="nama" class="form-control form-control-lg" placeholder="Enter Your Name" required />
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td>
              <input type="text" name="no_hp" id="no_hp" class="form-control form-control-lg" placeholder="Enter Number Phone" required />
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td>
              <select class="form-select" name="level" id="level" style="width: 100%;">
