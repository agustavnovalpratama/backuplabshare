...
<body>
  ...
  <div class="container-fluid text-light" style="height: 100vh;">
    <div class="nav row justify-content-evenly text-center align-items-center">
      <div class="col-sm-6">
        <div class="card text-bg-warning mb-3">
          <div class="card-body">
            <h3 class="card-title fw-bold">WELCOME TO THE LABORATORY <p>REKAYASA PERANGKAT LUNAK</p></h3>
    ...
    <!--Card Item Start-->
    <div class="row justify-content-evenly text-center align-items-center mt-lg-2">
      <div class="col-sm-6">
        <div class="col-sm-12 g-3 mt-4">
          <div class="card">
            <div class="card-body text-body">
              ...
              <a href="data_peminjaman_lab.php" class="btn btn-dark d-block" target="_blank">Pergi</a>
        ...
        <div class="col-sm-12 g-3 mt-4">
          <div class="card">
            <div class="card-body text-body">
              ...
              <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
              <a href="data_pengembalian_lab.php" class="btn btn-dark d-block" target="_blank">Pergi</a>
        ...
        <div class="col-sm-12 g-3 mt-4">
          <div class="card">
            <div class="card-body text-body">
              ...
              <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
              <a href="data_pelaporan_lab.php" class="btn btn-dark d-block" target="_blank">Pergi</a>
