...
<body>
  ...
  <div class="container-fluid text-light" style="height: 100vh;">
    ...
    <div class="row justify-content-evenly  align-items-center text-body">
      <div class="col-sm-6">
        <form action="simpan_pelaporan.php" method="post">
          <div class="form-row">
            <div class="form-group">
              <label>Id Alat</label>
              <select class="form-select" name="idalat">
                ...
                <option value="trip5">Tripod - trip5</option>>
              </select>
            </div>
          </div>
          ...
          <div class="form-row mt-3">
            <div class="form-group">
              ...
              <input type="text" name="detail" class="form-control" id="" required>
            </div>
          </div>
          <div class="form-row mt-3">
            <div class="form-group">
          ...
          <div class="form-row mt-3">
            <div class="form-group">
              <label for="input_from"><i class="fa-solid fa-calendar-days"></i> Tanggal Pelaporan</label>
              <input type="text" name="tgl_lapor" class="form-control" id="input_from" placeholder="Start Date" style="width: 180px;">
            </div>
          </div>
